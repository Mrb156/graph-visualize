from PyQt6.QtWidgets import QDialog, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QScrollArea, QWidget
...
class UniquePropertyDialog(QDialog):
    ...
    def add_attribute(self):
        ...
        value_label = QLabel("Attribute Value:", self)
        ...
        self.attributes.append((name_input, value_input))

    def get_attributes(self):
        """Return the attributes as a dictionary."""
        return {name_input.text(): value_input.text() for name_input, value_input in self.attributes if name_input.text() and value_input.text()}